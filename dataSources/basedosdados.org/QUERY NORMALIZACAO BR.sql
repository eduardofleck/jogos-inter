update [TRANSFERMARKET_BR] set estadio = 'Estádio Cícero Pompeu de Toledo' where estadio = 'MorumBIS'
update [TRANSFERMARKET_BR] set estadio = 'Estádio Frei Epifânio DAbadia' where estadio = 'Estádio Frei Epifânio D''Abadia'
update [TRANSFERMARKET_BR] set estadio = 'Estádio Rafael Seabra' where estadio is null and time_mandante = 'Tuntum'
update [TRANSFERMARKET_BR] set time_mandante = 'Cuiabá' where time_mandante = 'Cuiabá-MT'
update [TRANSFERMARKET_BR] set time_visitante = 'Cuiabá' where time_visitante = 'Cuiabá-MT'
...
update [TRANSFERMARKET_BR] set time_mandante = 'Nova Iguaçu' where time_mandante = 'Nova Iguaçu-RJ'
update [TRANSFERMARKET_BR] set time_visitante = 'Nova Iguaçu' where time_visitante = 'Nova Iguaçu-RJ'
...
update [TRANSFERMARKET_BR] set time_mandante = 'Goiás EC' where time_mandante = 'Goiás'
